...
export function ProductForm(element, product, options) {
    ...
    if (options.onSellingPlanChange) {
        this.sellingPlanInputs = this._initInputs(
            selectors.sellingPlanInput,
            options.onSellingPlanChange
        );
    }
}
...
ProductForm.prototype.selling_plan = function () {
    return null;
}
 ...
 *
 * @returns {number|number} Collection of objects with name and value keys
 */
...
ProductForm.prototype._setIdInputValue = function (value) {
    let idInputElement = this.element.querySelector(selectors.idInput);
...
ProductForm.prototype._onOptionChange = function (options, event) {
    ...
    if (typeof options.onOptionChange !== "function") {
        return;
    }
...
ProductForm.prototype._onSubmit = function (options, event) {
    ...
    if (typeof options.onFormSubmit !== "function") {
        return;
    }
...
ProductForm.prototype._getProductFormEventData = function () {
    ...
    const selling_plan = this.selling_plan();
    if (selling_plan) {
        data = {
            ...data,
            selling_plan,
...
function _serializeSellingPlanValue(inputs, transform) {
    return inputs.reduce(function (properties, input) {
        if (
            input.checked || // If input is a checked (means type radio or checkbox)
            (input.type !== "radio" && input.type !== "checkbox") // Or if its any other type of input
